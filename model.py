...
class Customer(db.Model):
    ...
    modified = db.Column(db.Date, default=datetime.datetime.today())
...
class Quote(db.Model):
    ...
    invoices = db.relationship('Invoice_Detail', back_populates='product')
    customer = db.relationship('Customer', backref=db.backref('quotes'), foreign_keys=[customer_id])
...
class Invoice(db.Model):
    ...
    customers = db.relationship('Customer', backref=db.backref('invoice'), foreign_keys=[customer_id])
...
class Invoice_Detail(db.Model):
    ...
    created_at = db.Column(db.DateTime(ts))
    modified = db.Column(db.DateTime(ts))
